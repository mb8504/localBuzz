...
const GreenHop = () => <img src="src/assets/greenhops.png" alt="Green Hop" className="h-40 w-28" />;
const WhiteHop = () => <img src="src/assets/whitehops.png" alt="White Hop" className="h-40 w-28 animate-bounce" />;
const GreenHop2 = () => <img src="src/assets/greenhops.png" alt="Green Hop" className="h-40 w-28" />;
const WhiteHop2 = () => <img src="src/assets/whitehops.png" alt="White Hop" className="h-40 w-28 animate-bounce" />;
const GreenHop3 = () => <img src="src/assets/greenhops.png" alt="Green Hop" className="h-40 w-28" />;
const WhiteHop3 = () => <img src="src/assets/whitehops.png" alt="White Hop" className="h-40 w-28 animate-bounce" />;
